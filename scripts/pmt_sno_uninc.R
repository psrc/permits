...
uninc.iss.file <- "uninc_issued2015.xlsx"
Uninc.fin.file <- "uninc_finaled2015.xlsx" 
...
unique.iss <- dt.iss.raw[!match.result2] #1115 recodrs returned that are unique (iss)
